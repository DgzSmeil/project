                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-12 top-mar">
                                                                    ...
                                                                    <div class="single-product">
                                                                        <div class="single-product-img">
                                                                            <a href="<%=path %>/article/look?article.id=${d.id}" target="_blank"><img src="<%=path %>/upload/${d.logo }"style="width:280px;height:300px;"/></a>
                                                                        </div>
                                                                    </div>
                                                                    <!-- single-product-end -->
                                                                </div>
                                                                    ...
                                                                    <div class="single-product">
                                                                        <div class="single-product-content">
                                                                            <div class="product-title">
                                                                                <h2>
                                                                                    <a href="<%=path %>/article/look?article.id=${d.id}" target="_blank">${d.title }</a>
                                                                                </h2>
                                                                            </div><br/>
                                                                            <div class="price-box">
                                                                                <label>创建时间：</label><span>${d.created_time }</span>
                                                                            </div>
	                                                                            <label>文章摘要：</label><span>${d.abstracts }</span>
                                                                        </div>
                                                                    </div>
                                                                    <!-- single-product-end -->
                                                                </div>
    		...
    		$.post(url,{
    			...
    			function(data){
    				...
    				for(var i=0;i<data.rows.length;i++){
    					...
    					trs+="<a href='"+basePath+"/article/look?article.id="+data.rows[i].id+"' target='_blank'><img src='"+basePath+"/upload/"+data.rows[i].logo+"'style='width:280px;height:300px;'/></a>";
    					trs+="</div></div></div>";    
    					trs+="<div class='col-md-6 col-sm-6 col-xs-12 top-mar'>";         
    					trs+="<div class='single-product'>";               
    					trs+="<div class='single-product-content'><div class='product-title'><h2>";        
    					trs+="<a href='"+basePath+"/article/look?article.id="+data.rows[i].id+"' target='_blank'>"+data.rows[i].title+"</a>";       
    					trs+="</h2></div><br/>"; 
    					trs+="<div class='price-box'><label>发表时间：</label><span>"+data.rows[i].created_time+"</span></div>"; 
    					trs+="<label>文章摘要：</label><span class='product-desc'>"+data.rows[i].abstracts+"</span><br/>";    
    					trs+="</div></div></div></div>";
    				}
    				$("#gdsfa").html(trs);
    			},
