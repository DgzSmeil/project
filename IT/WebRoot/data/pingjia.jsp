...
<form action="<%=basePath %>courseservlet?order=pingjia" method="post" name="form1">
...
<div class="Page" id="tips">
	<div class="CourseComm_Top">
		<h2>课程评价</h2>
		<div>综合评价在4.0颗星及以上可最高获得30学分奖励</div>
		<div><a href="/index/help.html" target="_blank">查看规则</a></div>
		<div class="CourseComm_Help">
			<p>如何进行课程评价？综合评价如何计算？课程评价学分奖励规则是什么？</p>
		</div>
		<p class="clear"></p>
	</div>
	<div class="CourseComm_Info" style="width:1000;height:200">
		<div style="float:left">
			<img width="380" height="160" src="<%=basePath%><%=request.getParameter("imgsrc") %>"/>
		</div>
		<div style="float:left">
			<font size="5"><%=request.getParameter("coursename") %></font><br/>
			<p><font size="4">该课程已有 6人评价</font></p>
		</div>
	</div>
	<div class="clear"></div>
	<div class="CourseComm_Action">
		<h2>我要评分<span>要评分才可以发布哦~</span></h2>
		<ul class="CourseComm_ActionList">
			<li class="CourseComm_ActionItem">
				<p>课程与描述相符</p>
				<input type="hidden" id="fenshu1" name="fengshu1" value="" />
				<ul class="courseAction">
					<li class="noStar"></li>
					<li class="noStar"></li>
					<li class="noStar"></li>
					<li class="noStar"></li>
			...
			<li class="CourseComm_ActionItem">
				<p>老师的讲解表达</p>
				<input type="hidden" name="fengshu2" value="" />
				<ul class="courseAction">
					<li class="noStar"></li>
					<li class="noStar"></li>
					<li class="noStar"></li>
			...
			<li class="CourseComm_ActionItem">
				<p>老师的答疑服务</p>
				<input type="hidden" name="fengshu3" value="" />
				<ul class="courseAction">
					<li class="noStar"></li>
					<li class="noStar"></li>
					<li class="noStar"></li>
