...
<body>
	...
	<div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>省份的修改</strong></div>
		...
		<form method="post" name="form1" class="form-x" action="<%=basePath %>provinceservlet?order=update" onsubmit="return check();">
		<input type="hidden" name="provinceid" value="${param.provinceid}">
		<div class="form-group">
	        <div class="field">
	  			<input type="text" class="input w50"  name="provincename" data-validate="required:请填写省份名称" value="<%=new String(request.getParameter("provincename").getBytes("iso-8859-1"),"utf-8") %>">
	        <div class="tips"></div>
	        </div>
     	</div>
        <div class="field">
