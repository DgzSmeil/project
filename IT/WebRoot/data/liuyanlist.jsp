    ...
    <table class="table table-hover text-center">
			...
			<tr height='40'>
				...
				<td align="center">
					<div class="button-group">
						...
						<a class="button border-main icon-edit"  href="<%=basePath %>exchangecodeservlet?activityid=${y.activity_id}&order=list">优惠券管理</a>&nbsp;&nbsp;&nbsp;
      ...
      <tr width="100%">
		...
		<td class="pagelist" colspan="2" align="center">
			...
			<a href="<%=basePath %>activeservlet?order=list&currenpage=1&handle=firstpage">首   页</a>
			<a href="<%=basePath %>activeservlet?order=list&currenpage=${pager.currentpage }&handle=uppage">上一页</a> <span class="current">1</span>
			<a href="<%=basePath %>activeservlet?order=list&currenpage=${pager.currentpage }&handle=downpage" >下一页</a>
			<a href="<%=basePath %>activeservlet?order=list&currenpage=${pager.sumpage }&handle=lastpage">尾  页</a> 
		</td>
      </tr>
    </table>
