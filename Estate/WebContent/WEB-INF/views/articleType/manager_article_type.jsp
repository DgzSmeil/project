...
<div class="pageheader">
		<h2><i class="fa fa-th-list"></i>文章类别管理 <span>所有文章类别</span></h2>
		     	...
		     	<thead> 
		          <tr>
		          	  <th data-radio="true" data-valign="middle"></th>                              
			       	  <th data-field="name" data-valign="middle">类别名称</th>            
		       		  <th data-field="des"  data-valign="middle">类别描述</th>  
                ...
                <div class="modal-body" style="text-align:center;">
			   	<form class="form-horizontal form-bordered" method="post" action="<%=path %>/agency/agcedit" id="form1"  enctype="multipart/form-data">
						<div class="form-group" id="div2">
						  ...
						  <div class="col-sm-4">
							<input type="text" id="articleTypeName" name="articleType.name" data-placement="right" class="form-control tooltips">
						  </div>
...
<script src="<%=path %>/js/bootstrap_articleType.js"></script>
