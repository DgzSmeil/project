  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      <tr>
		...
		<th align='center' width="10%">讲师名称</th>
			...
			<tr height='40'>
				...
				<td align="center">
					<div class="button-group">
						<c:if test="${y.status!=1}">
							<a class="button border-main icon-edit"  href="<%=basePath %>refundservlet?refundid=${y.refundid}&order=update"> 修 改 </a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<c:if test="${y.status==1}">
							<a class="button border-main icon-edit"  href="<%=basePath %>refundservlet?refundid=${y.refundid}&order=update"> 详 情 </a>&nbsp;&nbsp;&nbsp;
						</c:if>
