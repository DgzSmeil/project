			...
			<tr height='40'>
				...
				<td align="center">
					<div class="button-group"> 
						...
						<a  class="button border-red icon-trash-o" href="<%=basePath %>courselistservlet?carid=${y.carid}&order=delete1"  onclick="javascript:if(confirm('删除确认')){return true;}else{return false;}"> 删 除 </a>
					</div>
				</td>
			</tr>
		</c:forEach>
