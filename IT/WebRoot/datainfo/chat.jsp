...
<html xmlns="http://www.w3.org/1999/xhtml"
	...
	<head>
		...
		<meta name="description"
			content="51CTO学院是专业的IT在线教育平台，聘请云计算、大数据、HTML5、网络安全、服务器、Android、iOS、开发技术、SQL Server、Oracle、数据库等技术领域的专家，更有思科认证、软考、Linux认证、微软认证、H3C认证系列精品IT在线培训课程，汇集最顶尖的IT技术精品课程，最优秀的IT培训讲师授课，大量技术培训教程，学员付费后可在线观看，此外还可以获得专家讲师亲自答疑，并参加课程的在线评测。" />
	...
	<body>
		...
		<div class="GenTopHeader" style="margin-top: 0px;">
			<ul class="Page" id="GenTopBar">
				...
				<li class="fr navi">
					<a target="_blank" style="background-color: none;">网站导航</a>
					<ul class="navigates">
						<li>
		...
		<div class="pagebg" style="width: 100%; background: #fff;">
			<div class="Page" style="height: 90px;">
				<a href="<%=basePath%>courselistservlet?order=list" target="_blank">
					<img src="<%=basePath%>image/bg1.jpg" /> </a>
			</div>
		</div>
		<div class="Header">
			<div class="Page">
	 	...
	 	<c:forEach items="${forlist}" var="f">
		 	<tr>
		 		<td align="left" >
			 		<c:if test="${f.fourmtype==0}">
				 		<div style="float:left">
				 			<p><img src="${f.userface}" width="50px" height="50px" style="border-radius:50%"/><font size="4">${f.username}
				 			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提问：${f.countent}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${f.forumdate}</font></p>
				 		</div>
			 		</c:if>
		 		</td>
		 		<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		 	...
		 	<tr>
		 		<td align="right">
		 			<c:if test="${f.fourmtype==1}">
				 		<div style="float:right">
				 			<p><img src="${f.teacherface}" width="30px" height="30px"/>${f.teachername}
				 			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;回复：${f.countent}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="text-align: right">${f.forumdate}</b></p>
				 		</div>
				 	</c:if>
		 		</td>
		 		<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		...
		<div class="Footer">
			<div class="Page">
				<table class="QRcode tc">
					<caption>
						<a href="<%=basePath%>courselistservlet?order=app" title="IT课堂"><img
								src="<%=basePath%>image/itlogo.png" alt="51cto学院" width="194"
								height="40" />
					</caption>
					<tr>
						<td>
							<img src="<%=basePath%>images/it.bmp" alt="学院APP" width="110"
								height="110" />
							<p>
								学院APP
							</p>
						...
						<td>
							<img src="<%=basePath%>images/it.bmp" alt="官方微信" width="110"
								height="110" />
							<p>
								官方微信
							</p>
