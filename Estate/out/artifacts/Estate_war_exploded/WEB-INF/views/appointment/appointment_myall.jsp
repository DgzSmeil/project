    ...
    <div class="contentpanel">
	    <div class="div_left" style="margin-right: 50px;">
	      <ul class="dsa">
			...
			<li class="active"><a href="<%=path %>/appointment/myall">我的预约</a></li>
				    ...
				    <div class="col-md-9">
				        <table class="table table-hover" id="cusTable"  
						       ...
						       data-showColumns="true">  
						       	  <colgroup>
						       		<col style="width:70px;height:200px">
						     	...
						     	<thead> 
						          <tr>
							       	  <th data-field="house.logo"  data-valign="middle" data-formatter="logoFormatter">户型封面</th>            
						       		  <th data-field="house.name"  data-valign="middle">户型名称</th>  
						       		  <th data-field="employee.name" data-valign="middle">预约员工</th>
						       		  <th data-field="employee.phone" data-valign="middle">员工手机</th>
						       		  <th data-field="app_arrive_time" data-valign="middle">预约看房时间</th>
						       		  <th data-field="" data-valign="middle" data-formatter="logoFormatter4"></th>  
						          </tr>  
						       </thead>  
						       <tbody>  
						       </tbody>  
	...
	<script type="text/javascript">
		...
		function initTable() {  
		    ...
		    $("#cusTable").bootstrapTable({  
		        ...
		        url: basePath+"/appointment/myall2", //获取数据的Servlet地址  
		  ...
		  function logoFormatter(value,row,index){
				return "<a href='"+basePath+"/house/look?house.id="+row.house_id+" 'target='_blank'><img src='"+basePath+"/upload/"+row.house.logo+"' width='100' height='70'  alt='头像'></a>";
		  }
		  
		  function logoFormatter4(value,row,index){
				return "<a href='javascript:void(0);' onclick='dele(\""+row.id+"\");'>取消预约</a>";
		  }
		  function dele(id){
			  swal({   
				  title: "您确定要取消预约？",   
				  ...
				  function(isConfirm){   
					  if (isConfirm) {     
						  var url=basePath+"/appointment/del";
		        			$.post(url,{
		            			"appointment.id":id
		            			},
		            			function(data){
