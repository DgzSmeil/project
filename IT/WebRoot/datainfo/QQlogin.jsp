  ...
  <div class="page_accredit combine_page_children float_left">
    <div class="lay_main" id="lay_main">
      <div class="lay_accredit_con">
        ...
        <p class="app_site_wording"><a class="accredit_site" id="accredit_site_link" href="http://www.51cto.com" target="_blank">无忧技术网</a>将获得以下权限：</p>
        <div class="accredit_info" id="accredit_info">
          <ul class="accredit_info_op">
            ...
            <li>
              <input name="api_choose"  type="checkbox" class="checkbox oauth_checkbox" id="item_80901010" value="80901010" title="默认授权 不可更改" checked disabled />
              <label  for="item_80901010" class="oauth_item_title">获得您的昵称、头像、性别</label>
            </li>
            <li>
              <input name="api_choose"  type="checkbox" class="checkbox oauth_checkbox" id="item_2010" value="2010" title="" checked  />
...
<script>
    ...
    Q.authsCount = 2;
    Q.isNeedLogin = false;
    Q.crtDomain = 'http://www.51cto.com';
    Q.agree = function(){
    ...
    Q.ptlogin2 = function(){
        var s_url = 'https://graph.qq.com/oauth/login_jump';
