...
<div class="pageheader">
	...
	<div class="contentpanel">
      ...
      <div class="col-sm-9">
        ...
        <div class="panel panel-default panel-blog">
          <div class="panel-body">
            ...
            <ul class="blog-meta">
              ...
              <li><a href="">${ commentlist.size()} 评论</a></li>
            </ul>
        ...
        <div class="mb10"></div>
        <a href="<%=path %>/builds/update?builds.id=${builds.id}" class="btn btn-primary">修改资料</a>
        
        <div class="mb30"></div>
        <h5 class="subtitle">${ commentlist.size()} 评论</h5>
        <div class="mb30"></div>
        
        <ul class="media-list comment-list">
        <s:iterator id="comment" value="#request.commentlist">
        <li class="media">
	            <a class="pull-left" href="#">
	              <img class="media-object thumbnail" src="<%=path %>/upload/${comment.user.headicon}"  />
	            </a>
