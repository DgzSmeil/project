...
<form action="<%=basePath %>courselistservlet?order=tiwen" method="post" name="form1">
...
<div class="Page" id="tips">
	...
	<div class="CourseComm_Info" style="width:1000;height:200">
		...
		<div style="float:left">
			...
			<p><font size="4">该课程已有 6人提问</font></p>
		</div>
	</div>
	<div class="clear"></div>
	<div class="clear"></div>
	<div class="CourseComm_Talk">
		<h2>请选择操作&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tiwen" value="0"/>提问&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tiwen" value="1"/>回复</h2>
		<textarea id="CourseComm_Word" name="msg">赠人玫瑰 ，手有余香，提问，帮助更多学员~</textarea>
