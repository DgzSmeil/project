    ...
    <table class="table table-hover text-center">
			...
			<tr height='40'>
				...
				<td align='center'>
		          ...
		          <div class="button-group"> 
		          	<c:if test="${y.leibie ==2 }">
					  <a class="button border-main icon-edit" href="<%=basePath %>studentservlet?order=shenhestudent&studentmobile=${y.studentmobile}">进入审核</a>
					</c:if>
					<c:if test="${y.leibie !=2 }">
					  <a class="button border-main icon-edit" href="<%=basePath %>studentservlet?order=shenhestudent&studentmobile=${y.studentmobile}">查看详情</a>
					</c:if>
		          </div>
          </td>
        </tr>
      ...
      <tr width="100%">
		...
		<td class="pagelist" colspan="8" align="center">
			...
			<a href="<%=basePath %>studentservlet?order=checklist&currenpage=1&handle=firstpage">首   页</a>
			<a href="<%=basePath %>studentservlet?order=checklist&currenpage=${pager.currentpage }&handle=uppage">上一页</a> <span class="current">1</span>
			<a href="<%=basePath %>studentservlet?order=checklist&currenpage=${pager.currentpage }&handle=downpage" >下一页</a>
			<a href="<%=basePath %>studentservlet?order=checklist&currenpage=${pager.sumpage }&handle=lastpage">尾  页</a> 
		</td>
      </tr>
    </table>
<script type="text/javascript">
