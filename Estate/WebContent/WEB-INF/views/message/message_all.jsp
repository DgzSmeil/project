    ...
    <div class="contentpanel">
	    <div class="div_left" style="margin-right: 50px;">
	      <ul class="dsa">
			...
			<li class="active"><a href="<%=path %>/message/myall">我的留言</a></li>
						       ...
						       data-showColumns="true">  
						     	...
						     	<thead> 
						          <tr>
						       		  ...
						       		  <th data-field="content" data-valign="middle"  data-formatter="logoFormatter2">留言内容</th>
						       		  <th data-field="reply" data-valign="middle" data-formatter="logoFormatter3">回复内容</th>
						       		  <th data-field="" data-valign="middle"  data-formatter="logoFormatter4">操作</th>  
						          </tr>  
						       </thead>  
						       <tbody>  
						       </tbody>  
	...
	<script type="text/javascript">
		...
		function initTable() {  
		    ...
		    $("#cusTable").bootstrapTable({  
		        ...
		        url: basePath+"/message/myall2", //获取数据的Servlet地址  
		  ...
		  function logoFormatter2(value,row,index){
				  return row.content+"<br/><span class='time_small'>(留言时间:"+row.leave_time+")</span>";
		  }
		  function logoFormatter3(value,row,index){
			  if(row.reply==null){
				  return "暂无回复";
			  }else{
				  return row.reply+"<br/><span class='time_small'>(回复时间:"+row.reply_time+")</span>";;
			  }
				
		  }
		  function logoFormatter4(value,row,index){
				return "<a href='javascript:void(0);' onclick='dele(\""+row.id+"\");'>删除留言</a>";
		  }
		  function dele(id){
			  swal({   
				  title: "您确定要删除留言？",   
				  ...
				  cancelButtonText: " 不 删 除 ",
				  closeOnConfirm: false }, 
				  function(isConfirm){   
					  if (isConfirm) {     
						  var url=basePath+"/message/del";
		        			$.post(url,{
		            			"message.id":id
		            			},
		            			function(data){
