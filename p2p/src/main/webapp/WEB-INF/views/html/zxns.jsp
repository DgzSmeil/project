...
<div class="about-content">
	<div id="zxns" class="content">
		...
		<p class="text">简历发送至<a href="1427916171@qq.com">xinyan.feng@pujinziben.com</a>，请在邮件标题中注明职位。</p>
		<div class="zx-title" style="margin-top:20px">
			<div class="children1">职位名称</div>
			<!-- <div class="children2">职位类别 </div> -->
			<div class="children2">发布时间</div>
		</div>
		<div class="zx-title zx-jobs">
			<div class="children1">行政前台</div>
			<div class="children2">2017-12-23</div>
		</div>
		<div class="jobs-box">
			<p class="tips">岗位职责：</p>
			<p>
		...
		<div class="zx-title zx-jobs">
			<div class="children1">人力资源主管</div>
			<div class="children2">2017-12-23</div>
		</div>
		<div class="jobs-box">
			<p class="tips">岗位职责：</p>
