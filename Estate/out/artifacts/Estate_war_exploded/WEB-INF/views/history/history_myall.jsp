    ...
    <div class="contentpanel">
	    <div class="div_left" style="margin-right: 50px;">
	      <ul class="dsa">
			...
			<li class="active"><a href="<%=path %>/history/myall">我的足迹</a></li>
		  </ul>
		</div>
						       ...
						       data-showColumns="true">  
						     	...
						     	<thead> 
						          <tr>
						       		  ...
						       		  <th data-field="created_time" data-valign="middle">遗留时间</th>
	...
	<script type="text/javascript">
		...
		function initTable() {  
		    ...
		    $("#cusTable").bootstrapTable({  
		        ...
		        url: basePath+"/history/myall2", //获取数据的Servlet地址  
		  ...
		  function logoFormatter4(value,row,index){
				return "<a href='javascript:void(0);' onclick='dele(\""+row.id+"\");'>删除足迹</a>";
		  }
		  function dele(id){
			  swal({   
				  title: "您确定要删除足迹？",   
