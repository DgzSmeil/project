...
<body>
	...
	<div class="pageheader">
		<h2><i class="glyphicon glyphicon-user"></i> 销售管理<span>所有用户</span></h2>
		...
		<input type="hidden" id="asd"  name="agency_id" value="${angency_id }">
       ...
       <table class="table table-hover" id="cusTable"  
		       ...
		       <thead>  
		          <tr>
		              ...
		              <th  data-field="sale_time"  data-formatter="formatDate">销售时间</th>
		              <th  data-field="unit_price" >销售单价</th>
		              <th  data-field="room.name" >房屋编号</th>
...
function initTable() {  
    ...
    $("#cusTable").bootstrapTable({  
        ...
        url: basePath+"/sale/agencysale", //获取数据的Servlet地址  
        striped: true,  //表格显示条纹  
