...
<div class="about-content">
	...
	<div id="falv" class="content">
		<div class="content-photo">
			<div class="content-photo-left">
				<img src="<%=path%>/static/resources/front/v01/src/images/about/guwen_01.png"/>
				<p class="name">赖华明</p>
	...
	<div id="shiwu"class="content">
		...
		<img class="img" src="<%=path%>/static/resources/front/v01/src/images/about/shiwu_03.png"/>
	</div>
</div>
