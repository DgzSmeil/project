...
//	占地面积
	...
	$('#building_area').blur(function(){
		if($(this).val().length==0){
			...
			$('#building_area').focus();
			$('#building_area').parent().next(".tips").text("建筑面积不能小于0");
			$('#building_area').parent().next(".tips").css("color",'red');
			document.getElementById( "div6" ).className = "form-group has-error";
			e.preventDefault();
			return;
	...
	$('#longitude').blur(function(){
		if($('#longitude').val().length==0){
			$('#longitude').parent().next("div").text("楼盘经度不能为空");
			$('#longitude').parent().next("div").css("color",'red');
		}else{
			document.getElementById( "div9" ).className = "form-group has-success"; 
			$('#longitude').parent().next("div").text("");
		}		
	})
	
	$('#latitude').blur(function(){
		if($('#latitude').val().length==0){
			$('#latitude').parent().next("div").text("楼盘纬度不能为空");
			$('#latitude').parent().next("div").css("color",'red');
		}else{
			document.getElementById( "div10" ).className = "form-group has-success"; 
			$('#latitude').parent().next("div").text("");
		}		
	})
	...
	$('#equipments').blur(function(){
		if($('#equipments').val().length==0){
			...
			document.getElementById( "div22" ).className = "form-group has-success"; 
	...
	$('#intro').blur(function(){
		if($('#intro').val().length==0){
			...
			document.getElementById( "div23" ).className = "form-group has-success"; 
...
//	提交按钮
	$("#btn_agency").click(function(e){	
		...
		$('#longitude').blur(function(){
			if($('#longitude').val().length==0){
				$('#longitude').focus();
				$('#longitude').parent().next(".tips").text("楼盘经度不能为空");
				$('#longitude').parent().next(".tips").css("color",'red');
		...
		$('#latitude').blur(function(){
			if($('#latitude').val().length==0){
				$('#latitude').focus();
				$('#latitude').parent().next(".tips").text("楼盘纬度不能为空");
				$('#latitude').parent().next(".tips").css("color",'red');
		...
		if($("#equipments").val().length==0){
			...
			document.getElementById( "div22" ).className = "form-group has-error";
			e.preventDefault();
			return;
		}else{
			$('#equipments').parent().next("div").text("");
		...
		if($("#intro").val().length==0){
			...
			document.getElementById( "div23" ).className = "form-group has-error";
			e.preventDefault();
			return;
		}else{
			$('#intro').parent().next("div").text("");
