...
<div class="filter">
    ...
    <div class="signinpanel">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="signin-info">
                    ...
                    <div class="mb20"></div>
                    <h2><a href="<%=path %>/agency/login"><font color="white"> 经 销 商 登 录</font></a></h2>
                </div><!-- signin0-info -->
        ...
        <ul class="nav nav-tabs nav-justified">
          <li class="active"><a href="#home3" data-toggle="tab"><strong>员工登录</strong></a></li>
        </ul>
        
        <!-- Tab panes -->
        <div class="tab-content">
          <div class="tab-pane active" id="home3">
			<form id="form" method="post" action="<%=path%>/emp/login">
				<h4 class="nomargin">账号登陆</h4>
		
				<input type="text" class="form-control uname"
					id="phone" name="employee.phone" placeholder="手机账号" />
				<div class=" tips"></div>
				<input type="password" class="form-control pword"
					id="pwd" name="employee.pwd" placeholder="登录密码" />
				<div class=" tips"></div>
...
<s:if test="#request.msg==1">
	<script type="text/javascript">
		swal("错误","账户名或密码错误，请重新登录","error");
	</script>
</s:if>
<s:if test="#request.msg==2">
	<script type="text/javascript">
		swal("警告", "你的账户已被冻结", "warning");
	</script>
</s:if>
</body>
<script>
$(function(){
	$("#btn").bind("click",function(){
		if($("#phone").val()==""){
			swal("提示","请输入登录账号","info");
			$("#phone").focus();
			return false;
		}else if($("#pwd").val()==""){
			swal("提示","请输入登录密码","info");
			$("#pwd").focus();
			return false;
		}else{
			$("#form").submit();
