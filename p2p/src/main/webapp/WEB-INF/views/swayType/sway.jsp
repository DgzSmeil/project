...
<table id="list" class="easyui-datagrid"
    ...
    <thead>
    <tr>
        <th data-options="field:'sid',width:80,checkbox:true">编号</th>
        <th data-options="field:'way',width:100">还款方式</th>
        <th data-options="field:'fw',width:100">算法</th>
        <th data-options="field:'stateToStr',width:100">还款状态</th>
    </tr>
    </thead>
</table>

<div id="tb" style="height: auto">
    <shiro:hasPermission name="sway:save">
        <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-add" onclick="openWin('addWin');">添加</a>
    </shiro:hasPermission>
    <shiro:hasPermission name="sway:update">
        <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-edit" onclick="openEditWin('editWin', 'list', 'editForm')">修改</a>
    </shiro:hasPermission>
    <shiro:hasPermission name="sway:delete">
        <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-remove" onclick="deleteWin('list');">删除</a>
    </shiro:hasPermission>
</div>

<div id="addWin" class="easyui-window normal_win" data-options="title:'添加还款方式', closed:true">
    <form id="addForm">
        <table>
            <tr>
                <td>还款方式名称</td>
                <td>
                    <input class="easyui-textbox easyui-validatebox" data-options="prompt:'请输入还款方式名称',
						required:true,
						validType:['length[2,20]'],
						novalidate:true" name="way"/>
                </td>
            </tr>
            <tr>
                <td>算法</td>
                <td>
                    <input class="easyui-textbox easyui-validatebox" data-options="prompt:'请输入算法名称',
						required:true,
						validType:['length[2,20]'],
						novalidate:true" name="fw"/>
                </td>
            </tr>
            <tr>
                <td>状态</td>
            ...
            <tr>
                <td><a class="easyui-linkbutton" onclick="save('/sway/save', 'addForm', 'addWin', 'list');">确认</a></td>
            </tr>
        </table>
    </form>
</div>

<div id="editWin" class="easyui-window normal_win" data-options="title:'编辑还款方式', closed:true">
    <form id="editForm">
        ...
        <table>
            <tr>
                <td>还款方式名称</td>
                <td>
                    <input id="way" class="easyui-textbox easyui-validatebox" data-options="prompt:'请输入还款方式名称',
						required:true,
						validType:['length[2,20]'],
						novalidate:true" name="way"/>
                </td>
            ...
            <tr>
                <td>算法</td>
                <td>
                    <input id="fw" class="easyui-textbox easyui-validatebox" data-options="prompt:'请输入算法名称',
						required:true,
						validType:['length[2,20]'],
						novalidate:true" name="fw"/>
                </td>
            ...
            <tr>
                <td><a class="easyui-linkbutton" onclick="edit('/sway/update', 'editForm', 'editWin', 'list');">确认</a>
                </td>
            </tr>
        </table>
    </form>
...
<script>
    ...
    function openEditWin(winId, listId, formId) {
        ...
        if (row) {
            ...
            $('#way').textbox("setValue", row.way);
            $('#fw').textbox("setValue", row.fw);
