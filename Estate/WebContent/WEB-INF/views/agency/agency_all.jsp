                                                    ...
                                                    <div class="col-md-4 col-sm-6 col-xs-12 mar-bot">
                                                        ...
                                                        <div class="single-product">
                                                            <div class="single-product-img" id="trs1">
                                                                <a href="<%=path%>/builds/lookagency?agency.id=${d.id}" target="_blank"><img src="<%=path %>/upload/${d.logo }"style="width:280px;height:300px;"/></a>
                                                            </div>
                                                            <div class="single-product-content" >
                                                                <div class="product-title">
                                                                    <h5 id="h5">
                                                                        <a href="<%=path%>/builds/lookagency?agency.id=${d.id}" target="_blank">${d.name }</a>
                                                                    </h5>
                                                                </div><br/>
                                                                <div class="price-box">
                                                                    <label id="price1">地址：</label><span>${d.address }</span>
                                                                </div>
                                                                 <div class="price-box">
                                                                    <label id="price1">联系电话：</label><span>${d.tel }</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- single-product-end -->
    		...
    		$.post(url,{
    			...
    			function(data){
    				...
    				for(var i=0;i<data.length;i++){
    					...
    					trs+="<a href='"+basePath+"/builds/lookagency?agency.id="+data[i].id+"' target='_blank'><img src='"+basePath+"/upload/"+data[i].logo+"' style='width:280px;height:300px;'/></a>";
    					trs+="</div>";        
    					trs+="<div class='single-product-content' ><div class='product-title'><h5 id='h5'><a href='"+basePath+"/builds/lookagency?agency.id="+data[i].id+"' target='_blank'>"+data[i].name +"</a></h5></div><br/>";                
    					trs+="<div class='price-box'><label id='price1'>地址：</label><span>"+data[i].address+"</span></div>";
    					trs+="<div class='price-box'><label id='price1'>联系电话：</label><span>"+data[i].tel+"</span></div>";           
    					trs+="</div></div></div>";        
    				}
    				$("#gried_view").html(trs);
    			},
