...
<body>
	...
	<div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>密码的修改</strong></div>
		...
		<form method="post" name="form1" class="form-x" action="<%=basePath %>studentservlet?order=checkpassword" onsubmit="return check();">
		<input type="hidden" name="studentname" value="${requestScope.name}">
		<c:if test="${msg!=null}">
			<script type="text/javascript">
				alert("${msg}");
			</script>
     	...
     	<div class="form-group">
	        ...
	        <div class="field">
	  			<input type="password" class="input w50" placeholder="请输入新密码"  name="newpassword"  data-validate="required:请填写新密码">
	        <div class="tips"></div>
	        </div>
     	</div>
     	<div class="form-group">
	        ...
	        <div class="field">
	  			<input type="password" class="input w50"  placeholder="请在次输入新密码"  name="newpassword1"  data-validate="required:请确认密码">
	        <div class="tips"></div>
	        </div>
     	</div>
        <div class="field">
