...
<div class="Page">
	<p class="SearchResultText">共找到 <span class="gre resultTotalNum">589</span> 个 "<span class="gre">java</span>" 相关结果</p>
	<ul class="SearchPageClassNav">
		<li class="SPCN_Item SPCN_Cur"><a href="javascript::" id="courseCount" on="172">课程(417)</a></li>
		<li class="SPCN_Item"><a href="/index.php?do=search&m=pack&q=java">套餐(45)</a></li>

		<li class="SPCN_Item"><a href="/index.php?do=search&m=roadmap&q=java">路线图(8)</a></li>
		<li class="SPCN_Item"><a href="/index.php?do=search&m=lecturer&q=java">讲师(119)</a></li>
