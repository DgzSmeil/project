...
function initTable() {  
    ...
    $("#cusTable").bootstrapTable({  
        ...
        url: basePath+"/house/mgnhousepager", //获取数据的Servlet地址  
        striped: true,  //表格显示条纹  
...
function logoFormatter(value,row,index){
	return "<a href='/Estate/upload/"+row.logo+"' data-lightbox='roadtrip' title='户型名称:"+row.name+"  户型面积:"+row.area+"平方米  参考单价:"+row.unit_price+"元'><img src='/Estate/upload/"+row.logo+"' style='width:180px;height:100px;'></a>";
  }
