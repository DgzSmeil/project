...
<body>
	...
	<div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>密码的修改</strong></div>
		...
		<form method="post" name="form1" class="form-x" action="<%=basePath %>teacherservlet?order=updatepassword" onsubmit="return check();">
		<c:if test="${msg!=null}">
			<script type="text/javascript">
				alert("${msg}");
			</script>
		...
		<div class="form-group">
	        ...
	        <div class="field">
	  			<input type="password" class="input w50" placeholder="原密码" name="oldpassword" data-validate="required:请填写旧密码">
	        <div class="tips"></div>
	        </div>
     	</div>
        <div class="field">
