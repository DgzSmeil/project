...
<div class="pageheader">
		<h2><i class="fa fa-th-list"></i>文章管理 <span>所有文章</span><span>新增</span></h2>
		...
		<!-- content goes here... -->
     	...
     	<div class="panel panel-default">
			<div class="panel-body panel-body-nopadding">
			  ...
			  <form name="upfile" class="form-horizontal form-bordered" method="post" action="<%=path %>/article/articleAdd" id="form1" enctype="multipart/form-data">
			  <input type="hidden" name="activity.agency_id" value="">
				...
				<div class="form-group" id="div1">
				  ...
				  <div class="col-sm-4">
					<input type="text" id="title" name="article.title" onblur="valide2();" placeholder="请输入标题" data-placement="right" title="与实际标题保持一致" class="form-control tooltips" required>
				...
				<div class="form-group" id="div1">
				  ...
				  <div class="col-sm-4">
				  	<s:select list="atcTypeList" name="article.article_type"  listKey="name" listValue="name"></s:select>
				  </div>
				  <div class="col-sm-4 tips"></div>
				</div>
				...
				<div class="form-group" id="div1">
				  ...
				  <div class="col-sm-4">
					<input type="text" id="abstracts" name="article.abstracts" onblur="valide2();" placeholder="请输入类别名称" data-placement="right" title="与实际类别标题保持一致" class="form-control tooltips" required>
				  	<div class="col-sm-20 tips"></div>
				  </div>
				  <div class="col-sm-4 tips"></div>
				</div>
				...
				<div class="form-group" id="div1">
				  ...
				  <div class="col-sm-4">
				  	<textarea  id="content"  name="article.content" onblur="valide3();" class="form-control" style="width:800px;height:500px;"></textarea>
				  	<div class="col-sm-20 tips"></div>
				  </div>
				  <div class="col-sm-4 tips"></div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
						<button  class="btn btn-primary btn-lg" id="btn_article" onclick="return valide();"> 添加 </button>&nbsp;
