...
<head>
    ...
    <title>安全保障-普金资本-安全可靠专注于供应链金融的国资背景P2P理财平台</title>
...
<div class="banner">
    <div class="banner-box"><img src="<%=path%>/static/resources/front/v01/src/images/safty.jpg" ></div>
</div>
<div class="safety">
    <div class="item-one">
        ...
        <div class="item-content">
            ...
            <img class="img" src="<%=path%>/static/resources/front/v01/src/images/safe/item1.png"/>
        </div>
    </div>
    <div class="item-two">
        <div class="wrap">
    ...
    <div class="item-three">
        ...
        <div class="item-content">
            <img class="img" src="<%=path%>/static/resources/front/v01/src/images/safe/item3.png" />
        </div>
    </div>
    <div class="item-four">
        <div class="wrap">
