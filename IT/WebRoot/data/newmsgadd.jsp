...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
	<form method="post" class="form-x" id="example" action="<%=basePath %>newmsgservlet?order=add" enctype="multipart/form-data" onsubmit="return check();">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
        <div class="field">
          <input type="file" class="input w50" name="fileup"  placeholder="输入上传公告封面" data-validate="required:请填写公告封面">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="msgContent"   placeholder="输入公告简介" data-validate="required:请填写公告简介"/>
          <div class="tips"></div>
        </div>
      </div> 
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="paixu"   placeholder="输入公告排序" data-validate="required:请填写公告排序"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" type="submit"> 发 布 公 告</button>
        </div>
      </div>
    </form>
  </div>
