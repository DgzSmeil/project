...
public class GetPhoneMessage {
	 ...
	 * 用户ID
	 */
	public static final String ACCOUNT_SID = "4888dff11e7949f89164e845aba53fd9";
	/**
	 * 密匙
	 */
	public static final String AUTH_TOKEN = "786cba52b8d04e29958ec49a03f12339";
	/**
	 * 请求地址前半部分
	 */
	...
	public static String smsContent = "【IT课堂】登录验证码："+randNum+"，如非本人操作，请忽略此短信。";//账号内已有模板
	/**
	 * 获取短信验证码
	 * @param to
	 * @return
...
//			System.out.println("正常编码："+object);
	...
	public static void main(String[] args) {
		String result = getResult("15679760329");//手机号
