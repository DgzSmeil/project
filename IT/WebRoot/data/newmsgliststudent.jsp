  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
     <tr>
		...
		<th align='center'>公告排序</th>
		<th align='center'>类    别</th>
	</tr>
        <tr>
          <c:forEach items="${msglist}" var="y">
			<tr height='40'>
				<td align='center'><img src="${y.imageurl}" width="40px" height="40px"></td>
      ...
      <tr width="100%">
		...
		<td class="pagelist" colspan="12" align="center">
			...
			<a href="<%=basePath %>newmsgservlet?order=studentlist&currenpage=1&handle=firstpage">首   页</a>
			<a href="<%=basePath %>newmsgservlet?order=studentlist&currenpage=${pager.currentpage }&handle=uppage">上一页</a>
			<a href="<%=basePath %>newmsgservlet?order=studentlist&currenpage=${pager.currentpage }&handle=downpage">下一页</a>
			<a href="<%=basePath %>newmsgservlet?order=studentlist&currenpage=${pager.sumpage }&handle=lastpage">尾  页</a> 
		</td>
      </tr>
    </table>
<script type="text/javascript">
