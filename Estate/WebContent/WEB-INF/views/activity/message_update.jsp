			...
			<div class="panel-body panel-body-nopadding">
			  ...
			  <form class="form-horizontal form-bordered" method="post" action="<%=path%>/activity/updateSave" id="form1" enctype="multipart/form-data">
				...
				<div class="form-group" id="div5">
				  ...
				  <div class="col-sm-4">
				  <img id="img" src="<%=path%>/upload/${user.headicon }" class="img-rounded" style="width:100px;height:80px">
				  </div>
				...
				<div class="form-group" id="div5">
				  ...
				  <div class="col-sm-4">
					<input type="text" id="address" value="${user.nickname }" class="form-control">
				  </div>
				  <div class="col-sm-4 tips"></div>
				</div>
				...
				<div class="form-group" id="div5">
				  ...
				  <div class="col-sm-4">
					<input type="text" id="address" value="${message.leave_time }" class="form-control">
				  </div>
				  <div class="col-sm-4 tips"></div>
			   ...
			   <div class="form-group" id="div11">
				  ...
				  <div class="col-sm-7">
					<textarea  id="content" name="activity.content" class="form-control" rows="5">${message.content }</textarea>
				  </div>
				</div>
