    ...
    <div class="contentpanel">
	    <div class="div_left" style="margin-right: 50px;">
	      <ul class="dsa">
			...
			<li class="active"><a href="<%=path %>/comment/myall">我的评价</a></li>
	...
	<script type="text/javascript">
		...
		function initTable() {  
		    ...
		    $("#cusTable").bootstrapTable({  
		        ...
		        url: basePath+"/comment/myall2", //获取数据的Servlet地址  
		  ...
		  function logoFormatter4(value,row,index){
				return "<a href='javascript:void(0);' onclick='dele(\""+row.id+"\");'>删除评价</a>";
		  }
		  function dele(id){
			  swal({   
				  title: "您确定要删除评价？",   
