...
<div class="panel admin-panel margin-top">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>讲师资料修改</strong></div>
  <div class="body-content">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" type="submit"> 更 改 资 料 </button>
        </div>
      </div>
    </form>
  </div>
