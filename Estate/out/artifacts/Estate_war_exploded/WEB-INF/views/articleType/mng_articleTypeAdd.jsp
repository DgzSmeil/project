...
<div class="pageheader">
		<h2><i class="fa fa-th-list"></i>文章类别管理 <span>所有文章类别</span><span>新增</span></h2>
		...
		<!-- content goes here... -->
     	...
     	<div class="panel panel-default">
			<div class="panel-body panel-body-nopadding">
			  ...
			  <form class="form-horizontal form-bordered" method="post" action="<%=path %>/articleType/articleTypeAdd" id="form1" enctype="multipart/form-data">
			  <input type="hidden" name="activity.agency_id" value="">
				<div class="form-group" id="div1">
				  <label class="col-sm-3 control-label">类别名称：</label>
				  <div class="col-sm-4">
					<input type="text" id="name" name="articleType.name" onblur="valide2();" placeholder="请输入类别名称" data-placement="right" title="与实际类别标题保持一致" class="form-control tooltips" required>
			  ...
			  <div class="form-group" id="div11">
				  ...
				  <div class="col-sm-7">
					<textarea  id="des" name="articleType.des" class="form-control" style="width:360px;height:200px;"></textarea>
				  	<div class="col-sm-20 tips"></div>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
						<button  class="btn btn-primary btn-lg" id="btn_articleType" onclick="return valide();"> 添加 </button>&nbsp;
