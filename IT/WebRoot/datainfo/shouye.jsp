...
<html>
	<head>
		...
		<link
			href="<%=basePath %>css/base.css?v=2.3.36"
			rel="stylesheet">
		<link href="<%=basePath %>css/gen_top.css?v=2.2.41"
			rel="stylesheet">
		<link href="<%=basePath %>css/home.css"
			rel="stylesheet">
		<script>
		</script>
		<script src="<%=basePath %>js/jquery.min.js"></script>
		<script
			src="<%=basePath %>js/prototype_create.js"></script>
		<script
			src="<%=basePath %>js/plugins.js?v=1.0.3"></script>
		<script src="<%=basePath %>js/mbox.js?v=1.0.1"></script>
		<script
			src="<%=basePath %>js/autoload_list.js?v=1.0.1"></script>
		<script src="<%=basePath %>js/base.js?v=1.0.3"></script>
	...
	<body onload="show()">
		...
		<div class="IndexHeader_old_bg Header3">
			<ul class="Page IndexHeader_old">
				...
				<li class="fr">
					...
					<div class="tab_more network_list">
						<ul class="list">
							...
							<li class="list_child">
								<a href="<%=basePath %>findcourselistservlet?order=list" target="_blank">微职位</a>
							</li>
							<li class="list_child">
								<a
							...
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">技能图谱</a>
							</li>
							<li class="list_child">
						...
						<ul class="list list_on">
							...
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">读书频道</a>
							</li>
						</ul>
						<ul class="list">
							<li class="list_child">
							...
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">微站</a>
							</li>
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">家园</a>
							</li>
						</ul>
						<ul class="list">
							<li class="list_child">
							...
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">实践录</a>
							</li>
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">专栏</a>
							</li>
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">原创</a>
							</li>
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">译文</a>
							</li>
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">专题</a>
							</li>
						</ul>
						<ul class="list list_on">
							<li class="list_child">
							...
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">人工智能</a>
							</li>
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">MDSA</a>
							</li>
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">早报</a>
							</li>
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">调查</a>
							</li>
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">视频</a>
							</li>
						</ul>
						<ul class="list">
							<li class="list_child">
							...
							<li class="list_child">
								<a href="<%=basePath %>snack/snack.jsp" target="_blank">贪吃蛇</a>
							</li>
							<li class="list_child">
								<a href="<%=basePath %>3Dquanwang/demo.html" target="_blank">3D拳王</a>
							</li>
							<li class="list_child">
								<a href="<%=basePath %>taiqiuyouxi/index.html"
									target="_blank">台球游戏</a>
							</li>
							<li class="list_child">
								<a href="<%=basePath %>streetfighter/fright.jsp"
									target="_blank">街头霸王</a>
							</li>
						</ul>
						<ul class="list">
							<li class="list_child">
							...
							<li class="list_child">
								<a href="javascript:void(0);" target="_blank">51CTO主站</a>
							</li>
						</ul>
				...
				<c:if test="${requestScope.summsg!=0}">
					<li class="fr">
						<a href="javascript:void(0);" onclick="alert('恭喜你！获得一个大礼包,请前往个人中心抽奖!');" style="width:50px">消息<b  id="news" style="display:none"><font color="red">(${requestScope.summsg})</font></b></a>
					</li>
				</c:if>
				<c:if test="${requestScope.summsg==0}">
					<li class="fr">
						<a href="javascript:void(0);" style="width:50px">消息<font color="red">(0)</font></a>
					</li>
				</c:if>
				<c:if test="${studentBean!=null}">
					<li class="fr">
		...
		<div class="Header3 white Fix">
			<div class="Page">
				<ul>
					...
					<li class="fl">
						<a href="javascript:void(0);">找课程</a>
						<div class="ALLCourse" id="ALLCourse">
							<div class="List" id="ALLCourseList"></div>
						</div>
					</li>
					<li class="fl">
						<a href="<%=basePath %>findcourselistservlet?order=list">微职位</a>
					</li>
					<li class="fl">
					...
					<li class="topSearch fl">
						<form action="<%=basePath %>courselistservlet?order=shousuo" method="post"
							id="TopSearchFrom">
							<input type="text" placeholder="找课程,找讲师" name="sousuo" maxlength="30">
					...
					<li class="fr links">
						...
						<div class="More">
							...
							<dl>
								...
								<dd class="th1">
									<p>
										<a href="javascript:void(0);" target="_blank">CTO训练营</a>
									</p>
									<p>
					...
					<li class="fr">
						<a class="fr" href="javascript:void(0);">登录/注册</a>
					</li>
					<li class="clear"></li>
				</ul>
			</div>
			...
			<ul class="tea_list">
				<li>
					<a class="tea_list_img"
						href="javascript:void(0);" title="赖国荣"
						target="_blank"> <img
				...
				<li>
					<a class="tea_list_img"
						href="javascript:void(0);" title="陈飞龙"
						target="_blank"> <img
		...
		<div class="atment_bg bgff w1160">
			<div class="title_box">
				...
				<a class="moreurl fr"
					href="javascript:void(0);" target="_blank">查看更多&gt;&gt;</a>
				<div class="clear"></div>
			</div>
			<ul class="news_list">
				<li>
					<a href="javascript:void(0);"
						target="_blank">IT课堂推出计算机考研免费公开课</a>
					<span>2017-05-31</span>
					<div class="clear"></div>
				</li>
				<li>
					<a href="javascript:void(0);"
						target="_blank">1+1&gt;2，IT课堂拓宽教育服务新边界</a>
					<span>2017-05-25</span>
					<div class="clear"></div>
				</li>
				<li>
					<a href="javascript:void(0);"
						target="_blank">IT课堂校园行 走进内蒙古大学</a>
					<span>2017-05-18</span>
					<div class="clear"></div>
				</li>
				<li>
					<a href="javascript:void(0);"
						target="_blank">进军企业IT培训，IT课堂正式推出企业版</a>
					<span>2017-05-12</span>
					<div class="clear"></div>
				</li>
				<li>
					<a href="javascript:void(0);"
						target="_blank">IT课堂微职位战略合作伙伴授牌</a>
					<span>2017-05-05</span>
					<div class="clear"></div>
				</li>
				<li>
					<a href="javascript:void(0);"
						target="_blank">微软MVP在IT课堂举办Access数据库公益讲座</a>
					<span>2017-04-26</span>
					<div class="clear"></div>
				</li>
				<li>
					<a href="javascript:void(0);"
						target="_blank">两天385万交易，IT课堂打造属于IT人的专属节日</a>
					<span>2017-04-21</span>
					<div class="clear"></div>
				</li>
				<li>
					<a href="javascript:void(0);"
						target="_blank">IT课堂成功入选教育部2017年首批“产学合作协同育人项目”</a>
					<span>2017-04-20</span>
					<div class="clear"></div>
				</li>
				<li>
					<a href="javascript:void(0);"
						target="_blank">IT课堂为海南互联网产业发展建言献策</a>
					<span>2017-04-12</span>
					<div class="clear"></div>
				</li>
				<li>
					<a href="javascript:void(0);"
						target="_blank">赖国荣：由社区进入IT培训，IT课堂的另类打法</a>
		...
		<div class="footer_bg">
			<div class="footer">
				...
				<ul class="footer_list">
					...
					<li>
						<a href="<%=basePath %>courselistservlet?order=help" target="_blank">视频卡顿反馈</a>
					</li>
					<li>
						<a href="<%=basePath %>courselistservlet?order=help"
							target="_blank">课程登记</a>
				...
				<ul class="footer_list">
					...
					<li>
						<a href="javascript:void(0);" target="_blank">论坛交流</a>
					</li>
					<li>
						<a href="javascript:void(0);" target="_blank">资料下载</a>
					</li>
				</ul>
				<ul class="footer_list">
					<li>
					...
					<li>
						<a href="javascript:void(0);" target="_blank">内容合作</a>
					</li>
					<li>
				...
				<ul class="footer_last">
					...
					<li>
						 <div class="Logo fl" style="float:left">
				            <img src="<%=basePath %>image/itlogo.png" style="width:140px;height:40px">
				            <table border="0">
				                <tr>
				                    <td>
				                        <img src="<%=basePath %>images/it.bmp" style="height:150px;width:160px">
				                        <p>学院APP</p>
				                    </td>
				                    <td>
				                        <img src="<%=basePath %>images/it.bmp"  style="height:150px;width:160px">
				                	...
				                	<div class="footer_company">
										<a href="<%=basePath %>courselistservlet?order=list" target="_blank"
											title="IT课堂_中国最大的IT技能学习平台"><img
												src="<%=basePath %>image/itlogo1.png"
												alt="IT课堂_中国最大的IT技能学习平台"> </a>
										<div>
											Copyright © 2017-2027
    ...
    s.parentNode.insertBefore(hm, s);
		...
		<div class="Side_right_bg" id="Side_list">
			<div class="Side_right">
				<a href="javascript:void(0);">系统/运维</a>
				<a href="javascript:void(0);">云计算</a>
				<a href="javascript:void(0);">大数据</a>
				<a href="javascript:void(0);">Web开发</a>
				<a href="javascript:void(0);">编程语言</a>
				<a href="javascript:void(0);">软件研发</a>
				<a href="javascript:void(0);">考试认证</a>
				<a href="javascript:void(0);">数据库</a>
				<a href="javascript:void(0);">网络/安全</a>
				<a href="javascript:void(0);">人工智能</a>
				<a href="javascript:void(0);">移动开发</a>
				<a href="javascript:void(0);">游戏开发</a>
				<a href="javascript:void(0);">嵌入式</a>
				<a href="javascript:void(0);">服务器</a>
				<a href="javascript:void(0);">企业信息化</a>
				<a href="javascript:void(0);">Office办公</a>
				<a href="javascript:void(0);">产品/设计</a>
