  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<%=basePath %>studentservlet?order=add"> 发布章节视频</a> </li>
        <li>搜索：</li>
        <li>
          ...
          <c:forEach items="${teacherlist}" var="y">
			<tr height='40'>
				...
				<td align="center">
					...
					<a  class="button border-red"  href="<%=basePath %>teacherservlet?teacherid=${y.teacherid}&order=delete" onclick="javascript:if(confirm('删除确认')){return true;}else{return false;}"> 删 除 </a>
					<a  class="button border-red"  href="<%=basePath %>data/updateteacherpwd.jsp?teacherid=${y.teacherid}"> 修改密码 </a>&nbsp;&nbsp;
				</td>
			</tr>
		</c:forEach>
      <tr width="100%">
