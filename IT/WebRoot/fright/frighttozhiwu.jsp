...
td.HandBookZombie{background: url(${pageContext.request.contextPath}/fright/images/interface/Almanac_ZombieWindow2.png) no-repeat; width:20%; height:16%; text-align:center}
#DivTeach{
...
#dHelp{width:614px;height:399px;background:url(${pageContext.request.contextPath}/fright/images/Help.png);position:absolute;display:none;left:143px;top:100px}
#dSelectLevel{position:absolute;width:100%;height:100%;font-weight:bold;display:none}
#dOptionsMenuBack{position:absolute;text-align:center;left:244px;top:60px;width:412px;height:483px;display:none;background:url(${pageContext.request.contextPath}/fright/images//OptionsMenuback32.png);_background:url(images/OptionsMenuback8.png)}
...
.OptionsMenuButton,.OptionsMenuButtonDown{background:url(${pageContext.request.contextPath}/fright/images//OptionsBackButton32.png);_background:url(${pageContext.request.contextPath}/fright/images/OptionsBackButton8.png);float:left;font-family:黑体;font-size:32px;cursor:pointer;width:360px;height:100px;margin-left:26px;display:inline;color:#FC6}
...
.SelectModal{color: #FC6; font-weight: bold;cursor:pointer;background: url(${pageContext.request.contextPath}/fright/images/interface/Button.png) no-repeat center;text-align:center;height:43px;width:115px}
.Menu{float:left;text-align:center;line-height:41px;font-weight:bold;font-family:黑体;color:#00CB08;height:41px;width:113px;background:url(${pageContext.request.contextPath}/fright/images/interface/Button.png)}
...
.Tom1{left:0;top:0;width:86px;height:91px;background:url(${pageContext.request.contextPath}/fright/images/interface/Tombstones.png) no-repeat}
.Tom2{position:absolute;left:0;top:0;width:86px;height:91px;background:url(${pageContext.request.contextPath}/fright/images/interface/Tombstone_mounds.png) no-repeat}
</style>
<script src="<%=basePath %>fright/js/Cfunction.js" type="text/javascript"></script>
<script src="<%=basePath %>fright/js/CPlants.js" type="text/javascript"></script>
<script src="<%=basePath %>fright/js/CZombie.js" type="text/javascript"></script>
...
<div id="dFlagMeter" style="visibility:hidden;position:absolute;z-index:255;left:50px;top:280px;width:500px;height:40px">
	...
	<div id="dFlagMeterContent" style="position:absolute;left:344px;width:157px;height:40px">
		...
		<img id="imgFlag1" src="${pageContext.request.contextPath}/fright/images/interface/FlagMeterParts2.png" style="left: 10px; top: 14px;display:none">
		<img id="imgFlag2" src="${pageContext.request.contextPath}/fright/images/interface/FlagMeterParts2.png" style="left: 40px; top: 14px;display:none">
		<img id="imgFlag3" src="${pageContext.request.contextPath}/fright/images/interface/FlagMeterParts2.png" style="left: 70px; top: 14px;display:none">
		<img id="imgFlag4" src="${pageContext.request.contextPath}/fright/images/interface/FlagMeterParts2.png" style="left: 100px; top: 14px;display:none">
		<img id="imgGQJC" src="${pageContext.request.contextPath}/fright/images/interface/FlagMeterLevelProgress.png" style="left: 35px; top: 29px;display:block">
		<img id="imgFlagHead" src="${pageContext.request.contextPath}/fright/images/interface/FlagMeterParts1.png" style="left: 139px; top: 13px">
	</div>
</div>
...
<div id="dSurface" class="WindowFrame" style="display:none;z-index:255">
	<div id="iSurfaceBackground">
		...
		<div style="position: absolute;background:url('${pageContext.request.contextPath}/fright/images/SelectorScreenStartAdventur.png');left:474px;top:80px;width:331px;height:146px;cursor:pointer" onMouseOver="this.style.backgroundPosition='bottom'" onMouseOut="this.style.backgroundPosition='top'" onClick="ShowLevel()"></div>
		<div style="position: absolute;background:url('${pageContext.request.contextPath}/fright/images/SelectorScreenSurvival.png');left:474px;top:203px;width:313px;height:131px;cursor:pointer" onMouseOver="this.style.backgroundPosition='bottom'" onMouseOut="this.style.backgroundPosition='top'" onClick="ShowMiniGame()"></div>
	</div>
	<div id="dSurfaceBack">
...
<div class="WindowFrame" id="dAll" style="position:absolute;left:0;top:0;width:900px;background-color:#000">
	...
	<!--选择卡片-->
	<div id="dSelectCard" align=center style="display:none;position:absolute;left:600px;top:0;width:465px;height:600px;z-index:1;background: url('${pageContext.request.contextPath}/fright/images/interface/SeedChooser_Background.png') no-repeat">
	...
	<div id="dTop" style="position:absolute;left:605px;top:561px;height:35px;width:123px;display:none;z-index:1;">
		<div id="dSunNum" style="background:url('${pageContext.request.contextPath}/fright/images/interface/SunBack.png') no-repeat;position:absolute;width:123px;height:35px"><span id="sSunNum" style="text-align:center;position:absolute;top:4px;left:43px;width:68px;font-family:Verdana;font-weight:bold;font-size:18pt"></span></div>
		<div id="tdShovel" style="position:absolute;width:71px;height:35px;left:130px;background: url('images/interface/ShovelBack.png') no-repeat;visibility:hidden"><img id="imgShovel" src="${pageContext.request.contextPath}/fright/images/interface/Shovel.png" onMouseDown="ChoseShovel(event)"></div>
	</div>
</div>
...
<table border="0" width="800" cellspacing="0" cellpadding="0" background="${pageContext.request.contextPath}/fright/images/interface/Almanac_IndexBack.jpg" height="600">
	<tr>
	...
	<tr>
		...
		<img border="0" src="${pageContext.request.contextPath}/fright/images/Plants/SunFlower/SunFlower.gif" width="73" height="74"><br>
		<br>
		<br>
		<br>
...
&nbsp;</td>
		...
		<img border="0" src="${pageContext.request.contextPath}/fright/images/Zombies/Zombie/Zombie.gif" width="149" height="130"><br>
&nbsp;<table border="0" width="113" background="${pageContext.request.contextPath}/fright/images/interface/Button.png" height="41" cellspacing="0" cellpadding="0">
			<tr>
...
&nbsp;</td>
	...
	<tr>
		...
		<table border="0" width="89" cellspacing="0" cellpadding="0" height="26">
			<tr>
				<td background="${pageContext.request.contextPath}/fright/images/interface/Almanac_CloseButton.png" style="cursor:pointer" onMouseOver="this.style.backgroundImage='url(images/interface/Almanac_CloseButtonHighlight.png)'" onMouseOut="this.style.backgroundImage='url(images/interface/Almanac_CloseButton.png)'" onClick="SetNone($('dHandBook'))" align="center">
...
<!--获得新植物-->
<div id="dNewPlant" style="display:none;position:absolute;width:800px;height:600px;background:url(${pageContext.request.contextPath}/fright/images/interface/AwardScreen_Back.jpg) no-repeat">
