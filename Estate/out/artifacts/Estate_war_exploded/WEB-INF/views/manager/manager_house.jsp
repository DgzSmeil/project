...
<div class="pageheader">
		<h2><i class="fa fa-th-list"></i>楼盘管理管理 <span>所有楼盘</span><span>查看户型</span></h2>
		     	...
		     	<thead> 
		          <tr>
		          	  <th data-radio="true" data-valign="middle"></th>                              
			       	  <th data-field="logo" data-valign="middle" data-formatter="logoFormatter">户型图片</th>            
		       		  <th data-field="name" data-valign="middle">户型名称</th>  
		       		  <th data-field="area" data-valign="middle">面积 </th>  
					  <th data-field="unit_price" data-valign="middle">参考单价</th>    
...
<script src="<%=path %>/js/bootstrap_house.js"></script>
