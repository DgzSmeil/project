...
<html class="no-js" lang="en">
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul class="ul1">
											...
											<li class="active"><a href="<%=path%>/activity/all">楼盘活动</a></li>
                            ...
                            <div class="category-products">
                                <div class="topbar-category">
                                    ...
                                    <div class="shop-breadcrumb">
                                        <ul class="asda">
                                        	<li>
                                        		<a href="javascript:void(0);" id="p1" onclick="page(1);"><</a>
                                        	</li>
                                            <li class="active">
                                                 <a href="javascript:void(0);" id="p1" onclick="page(1);">1</a>
                                            </li>
                                            <s:if test="#request.total>6">
                                            	<li id="nav_ul">
                                                	<a href="javascript:void(0);" id="p2" onclick="page(2);">2</a>
                                            	</li>
                                            </s:if>
                                            <s:if test="#request.total>12">
                                            	<li id="nav_ul">
                                                	<a href="javascript:void(0);" id="p3" onclick="page(3);">3</a>
                                            	</li>
                                            </s:if>
                                            <s:if test="#request.total>18">
                                            	<li id="nav_ul">
                                                	<a href="javascript:void(0);" id="p4" onclick="page(4);">4</a>
                                            	</li>
                                            </s:if>
                                            <s:if test="#request.total>18">
                                            	<li id="nav_ul">
                                                	<a href="javascript:void(0);" id="p5" onclick="page(5);">5</a>
                                            	</li>
                                            </s:if>
                                            <li id="nav_ul">
                                               <a href="javascript:void(0);" id="p6" onclick="page(2);">></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="category-product">
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active fade in" id="list_view">
                                                    <div class="list-view">
                                                        <div class="row" id="gdsfa">
                                                        	<s:iterator value="#request.rows" id="roewq" var="d">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 top-mar">
                                                                <div class="col-md-6 col-sm-6 col-xs-12 top-mar">
                                                                    <!-- single-product-start -->
                                                                    <div class="single-product">
                                                                        <div class="single-product-img">
                                                                            <a href="<%=path%>/activity/lookactivity?activity.id=${d.id}" target="_blank"><img src="<%=path %>/upload/${d.logo }"style="width:280px;height:300px;"/></a>
                                                                        </div>
                                                                    </div>
                                                                    <!-- single-product-end -->
                                                                </div>
                                                                    ...
                                                                    <div class="single-product">
                                                                        <div class="single-product-content">
                                                                            <div class="product-title">
                                                                                <h2>
                                                                                    <a href="<%=path%>/activity/lookactivity?activity.id=${d.id}" target="_blank">${d.title }</a>
                                                                                </h2>
                                                                            </div><br/>
                                                                            <div class="price-box">
                                                                                <label>活动地址：</label><span>${d.address }</span>
                                                                            </div>
	                                                                            <label>开始时间：</label><span class="product-desc">${d.start_time }</span><br/>
	                                                                            <label>结束时间：</label><span class="product-desc">${d.end_time }</span><br/>
	                                                                            <label>活动楼盘：</label>
	                                                                            <s:if test="#d.buildings_id==''">
	                                                                            	<span class="product-desc" id='fdfa'>管理员发布</span>
	                                                                            </s:if>
	                                                                            <s:else>
	                                                                            	<span class="product-desc" id='fdfa'>${d.buildings.name }发布</span>
	                                                                            </s:else>
                                                                        </div>
                                                                    </div>
                                                                    <!-- single-product-end -->
    ...
    function page(page) {
    	var url=basePath+"/activity/all2";
    	if(page!=""){
    		$.post(url,{
    			"page":page,
    			},
    			function(data){
    				...
    				for(var i=0;i<data.rows.length;i++){
    					trs+="<div class='col-md-12 col-sm-12 col-xs-12 top-mar'>";
    					trs+="<div class='col-md-6 col-sm-6 col-xs-12 top-mar'>";
    					trs+="<div class='single-product'>";
    					trs+="<div class='single-product-img'>";
    					trs+="<a href='"+basePath+"/active/lookactive?active.id="+data.rows[i].id+"' target='_blank'><img src='"+basePath+"/upload/"+data.rows[i].logo+"'style='width:280px;height:300px;'/></a>";
    					trs+="</div></div></div>";    
    					trs+="<div class='col-md-6 col-sm-6 col-xs-12 top-mar'>";         
    					trs+="<div class='single-product'>";               
    					trs+="<div class='single-product-content'><div class='product-title'><h2>";        
    					trs+="<a href='"+basePath+"/active/lookactive?active.id="+data.rows[i].id+"' target='_blank'>"+data.rows[i].title+"</a>";       
    					trs+="</h2></div><br/>"; 
    					trs+="<div class='price-box'><label>活动地址：</label><span>"+data.rows[i].address+"</span></div>"; 
    					trs+="<label>开始时间：</label><span class='product-desc'>"+data.rows[i].start_time+"</span><br/>";    
    					trs+="<label>结束时间：</label><span class='product-desc'>"+data.rows[i].end_time+"</span><br/>";        
    					trs+="</div></div></div></div>";
    				}
    				$("#gdsfa").html(trs);
    			},
