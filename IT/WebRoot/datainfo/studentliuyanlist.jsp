  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      <tr>
		...
		<th align='center' width="20%">内    容</th>
		<th align='center' width="10%">时    间</th>
		<th align='center' width="10%">类    别</th>
		<th align='center' width="40%">操    作</th>
      </tr>
        <tr>
      ...
      <tr width="100%">
		...
		<td class="pagelist" colspan="5" align="center">
			...
			<a href="<%=basePath %>courselistservlet?order=studentliuyanlist&currenpage=1&handle=firstpage&id=<%=studentBean.getStudentid() %>">首   页</a>
			<a href="<%=basePath %>courselistservlet?order=studentliuyanlist&currenpage=${pager.currentpage }&handle=uppage&id=<%=studentBean.getStudentid() %>">上一页</a> 
			<a href="<%=basePath %>courselistservlet?order=studentliuyanlist&currenpage=${pager.currentpage }&handle=downpage&id=<%=studentBean.getStudentid() %>" >下一页</a>
			<a href="<%=basePath %>courselistservlet?order=studentliuyanlist&currenpage=${pager.sumpage }&handle=lastpage&id=<%=studentBean.getStudentid() %>">尾  页</a> 
		</td>
      </tr>
    </table>
